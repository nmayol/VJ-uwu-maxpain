...
void Scene::render()
{
	...
	// CEL
	modelview = glm::scale(glm::mat4(1.0f), glm::vec3(5.0f, 5.0f, 1.0f));
	...
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(int(currentTime) % 600, 150.f, 0.f));
	...
	// PEDRA / TERRA
	modelview = glm::translate(glm::mat4(1.0f), glm::vec3(0.f, 240.f, 0.f));
	modelview = glm::translate(modelview, glm::vec3(320.f, 320.f, 0.f));
	modelview = glm::scale(modelview, glm::vec3(5.0f, 5.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-64.f, -64.f, 0.f));
	texProgram.setUniformMatrix4f("modelview", modelview);
	texQuad[2]->render(texs[1]);
	
	text.render("Videogames!!!", glm::vec2(10, CAMERA_HEIGHT-450), 32, glm::vec4(1, 1, 1, 1));
}
